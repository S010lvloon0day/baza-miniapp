...
const RIDDLE_TEXT  = 'Там нет ни одного острова в радиусе 2688 км. Только океан. И обломки того, что когда-то летело среди звёзд. Найди имя этой точки. Два слова.' // Загадка уровня 2
