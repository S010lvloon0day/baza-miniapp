...
const RIDDLE_TEXT  = 'Найди второй адрес того же магазина. Тут нет земли, но карта не врёт! Зайди внутрь — посмотри фотографии. На одной лежит чертёж. Первое слово на чертеже и модель телефона — вот твой код.' // Загадка уровня 2
